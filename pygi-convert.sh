...
\
    ...
    -pe "s/Gst.GhostPad\(/Gst.GhostPad.new\(/g;" \
    -pe "s/Gst.GhostPad\(/Gst.GhostPad.new\(/g;" \
    -pe "s/import appindicator/from gi.repository import AppIndicator3/g;" \
    -pe "s/appindicator.Indicator/AppIndicator3.Indicator.new/g;" \
    -pe "s/appindicator.STATUS_/AppIndicator3.IndicatorStatus./g;" \
    -pe "s/appindicator.CATEGORY_/AppIndicator3.IndicatorCategory./g;" \
    $f
done
